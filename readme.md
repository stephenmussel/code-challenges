...
```
/**
 * Determine how many patients from a list meet the definitions of hypertension
 * @param {array} - The input is an array of strings
 * @returns {number} - The output is a number
 */
...
```
/**
 * Determine how many people like an item.
 * @param {array} - The input is an array of strings
 * @returns {string} - The output is a string
 */
